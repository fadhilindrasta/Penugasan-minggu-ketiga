        ...
        <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
            <tr>
                ...
                <td>
                    ...
                    <form action="" method="post" class="header-search">
                        ...
                        $list11 = $database->query("select  nama_obat,kemasan,harga from  obat;");
            ...
            <tr>
                <td colspan="2" style="padding-top:30px;">
                    <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">Obat</p>
                </td>
                <td colspan="2">
            ...
            <tr>
                <td colspan="4" style="padding-top:10px;">
                    <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">Semua jenis obat (<?php echo $list11->num_rows; ?>)</p>
                </td>
            ...
            if ($_POST) {
                ...
                $sqlmain = "select * from obat where kemasan='$keyword' or nama_obat='$keyword' or nama_obat like '$keyword%' or nama_obat like '%$keyword' or nama_obat like '%$keyword%'";
            } else {
                $sqlmain = "select * from obat order by id desc";
            }
        ...
        if ($action == 'drop') {
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div style="display: flex;justify-content: center;">
                        <a href="delete-obat.php?id=' . $id . '" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"<font class="tn-in-text">&nbsp;Yes&nbsp;</font></button></a>&nbsp;&nbsp;&nbsp;
                        <a href="obat.php" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;No&nbsp;&nbsp;</font></button></a>
            ...
            $sqlmain = "select * from obat where id='$id'";
            $result = $database->query($sqlmain);
            $row = $result->fetch_assoc();
            $name = $row["nama_obat"];
            $kemasan = $row["kemasan"];
            ...
            <div id="popup1" class="overlay">
                    ...
                    . '</td>
                            ...
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Tambah Jenis Obat</p><br><br>
                                </td>
                            </tr>
                            <tr>
                            <form action="tambah-obat.php" method="POST" class="add-new-form">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="name" class="input-text" placeholder="nama obat" required><br>
                                </td>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="kemasan" class="input-text" placeholder="Jenis Kemsana" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="number" name="harga" class="input-text" placeholder="Harga Obat" required><br>
                                </td>
                            </tr>                        
                ...
                echo '
                    <div id="popup1" class="overlay">
                            ...
                            <br><br><br><br>
                                ...
                                <a href="obat.php" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;OK&nbsp;&nbsp;</font></button></a>
                ...
                echo '
                    ...
                    . '</td>
                                    ...
                                    <tr>
                                        ...
                                        Obat ID : ' . $id . ' (Auto Generated)<br><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <form action="edit-obat.php" method="POST" class="add-new-form">
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                        <input type="text" name="nama" class="input-text" placeholder="Nama Obat" value="' . $name . '" required><br>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="text" name="kemasan" class="input-text" placeholder="Doctor Name" value="' . $kemasan . '" required><br>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="number" name="harga" class="input-text" placeholder="Harga Obat" value="' . $harga . '" required><br>
                                        </td>
                                    </tr>
