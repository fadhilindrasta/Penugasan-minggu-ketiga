...
<body>
    ...
    $userrow = $database->query("select * from pasien where pusr_nm='$useremail'");
    $userfetch = $userrow->fetch_assoc();
    $userid = $userfetch["id"];
    $username = $userfetch["nama"];
    $no_rm = $userfetch["no_rm"];
    ...
    <div class="container">
        <div class="menu">
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-home menu-icon-home">
                        <a href="index.php" class="non-style-link-menu non-style-link-menu">
                            <div>
        ...
        <tr class="menu-row">
            <td class="menu-btn menu-icon-doctor-active  menu-active">
                <a href="daftar-poli.php" class="non-style-link-menu-active">
                    <div>
                        <p class="menu-text">Daftar Poli</p>
                </a>
    </div>
    </td>
    </tr>
    ...
    <div class="dash-body">
        <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
            <tr>
                <td width="13%">
                    <a href="daftar-poli.php"><button class="login-btn btn-primary-soft btn btn-icon-back" style="padding-top:11px;padding-bottom:11px;margin-left:20px;width:125px">
                ...
                <td>
                    ...
                    <form action="" method="post" class="header-search">
                        ...
                        $list11 = $database->query("select * from  daftar_poli where id_pasien = '$userid';");
            ...
            <tr>
                <td colspan="2" style="padding-top:30px;">
                    <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">Daftar</p>
                </td>
                <td colspan="2">
            ...
            if ($_POST) {
                ...
                $sqlmain = "select * from daftar_poli where docusr_nm='$keyword' or keluhan='$keyword' or keluhan like '$keyword%' or keluhan like '%$keyword' or keluhan like '%$keyword%'";
            } else {
                $sqlmain = "select * from daftar_poli order by id desc";
            }
        ...
        if ($action == 'drop') {
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <a class="close" href="daftar-poli.php">&times;</a> 
                    ...
                    . '</td>
                            ...
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Daftar Poli</p><br><br>
                                </td>
                            </tr>
                            <tr>
                            <form action="tambah-daftar-poli.php" method="POST" class="add-new-form">
                            <tr>
                            <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="no_rm" class="input-text"readonly placeholder="nomer Rm" value="' . $no_rm . '" required><br>
                                </td>
                            ...
                            <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <select name="poli" id="inputpoli" class="box">';
                ...
                for ($y = 0; $y < $list11->num_rows; $y++) {
                    ...
                    $sn = $row00["nama_poli"];
                    $id_poli00 = $row00["id"];
                    echo "<option value=" . $id_poli00 . ">$sn</option><br/>";
                };
                ...
                echo     '       </select><br><br>
                                ...
                                <tr>
                                    <td class="label-td" colspan="2">
                                        <select name="id_jadwal" id="inputjadwal" class="box">;
                                              <option value="900"></option><br/>             
                                        </select><br><br>
                                    </td>
                                </tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="keluhan" class="input-text" placeholder="nama dokter" required><br>
                                </td>
    ...
    <script>
        document.getElementById('inputpoli').addEventListener('change', function() {
            var polid = this.value;
            loadjadwal(polid);
        });

        function loadjadwal(polid) {
            var xhr = new XMLHttpRequestUpload();

            xhr.open('GET', 'https://localhost/poli/pasien/get-jadwal.php?poli_id=' + polid, true);
